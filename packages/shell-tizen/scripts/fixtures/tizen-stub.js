// Tizen native-API stub (test fixture).
//
// Used by media-keys.test.cjs to verify the shell's registered remote keys
// match this stub's getSupportedKeys() keymap. Originally part of the
// (removed) wgt-emulate browser harness; kept here as a co-located test
// fixture (JEL-141).
//
