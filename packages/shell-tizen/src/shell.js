...
(function () {
  ...
  // hard-capped -> dismiss("settlecap") at 22 s (JELA-56 CEO decision,
  // Option B: raised from the original 15 s so the hold-cover gate fires on
  // "settled" rather than cap-forcing — measured settle-after-flush is
  // ~20–23 s wall on the Q60R), tunable ONLY DOWN via
  // localStorage['jellyfin.shell.instantHomeSettleCapMs'] (1000..22000 ms;
  // anything else falls back to 22000 — never above). The partial-stall path
