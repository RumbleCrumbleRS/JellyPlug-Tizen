...
(function () {
  ...
  function injectChromium56Polyfills(doc) {
    ...
    polyfillTag.textContent = [
      ...
      "    }",
      "    return this.split(String(s)).join(typeof r==='function'?'':String(r));",
      "  };",
      "}",
      // String.prototype.matchAll  -- Chrome 73
      "if(!String.prototype.matchAll){",
      "  String.prototype.matchAll=function(re){",
      "    var flags=re.flags||((re.global?'g':'')+(re.ignoreCase?'i':'')+(re.multiline?'m':''));",
      "    if(flags.indexOf('g')<0)throw new TypeError('matchAll requires a global RegExp');",
      "    var s=String(this),r=new RegExp(re.source,flags),out=[],m;",
      "    while((m=r.exec(s))!==null){out.push(m);if(m[0]==='')r.lastIndex++;}",
      "    var i=0;return{next:function(){return i<out.length?{value:out[i++],done:false}:{value:undefined,done:true};},",
      "      [typeof Symbol!=='undefined'&&Symbol.iterator?Symbol.iterator:'@@iterator']:function(){return this;}};",
      "  };",
      "}",
      ...
      "  String.prototype.at=function(n){n=Math.trunc(n)||0;if(n<0)n+=this.length;return n<0||n>=this.length?undefined:this.charAt(n);};",
      "}",
      // Object.hasOwn  -- Chrome 93
      "if(!Object.hasOwn){",
      "  Object.hasOwn=function(o,k){if(o==null)throw new TypeError('Cannot convert undefined or null to object');return Object.prototype.hasOwnProperty.call(Object(o),k);};",
      "}",
      // Promise.any  -- Chrome 85
      "if(!Promise.any){",
      "  Promise.any=function(ps){",
      "    return new Promise(function(resolve,reject){",
      "      var arr=Array.from(ps),n=arr.length,errs=new Array(n),left=n;",
      "      if(n===0)return reject(new (window.AggregateError||Error)([],'All promises were rejected'));",
      "      arr.forEach(function(p,i){Promise.resolve(p).then(resolve,function(e){errs[i]=e;if(--left===0)reject(new (window.AggregateError||Error)(errs,'All promises were rejected'));});});",
      "    });",
      "  };",
      "}",
      ...
      "  };",
      "}",
      // Element.prototype.toggleAttribute  -- Chrome 69
      "if(typeof Element!=='undefined'&&!Element.prototype.toggleAttribute){",
      "  Element.prototype.toggleAttribute=function(name,force){",
      "    var has=this.hasAttribute(name);",
      "    if(arguments.length>1){if(force&&!has){this.setAttribute(name,'');return true;}if(!force&&has){this.removeAttribute(name);return false;}return !!force;}",
      "    if(has){this.removeAttribute(name);return false;}this.setAttribute(name,'');return true;",
      "  };",
      "}",
      "})();",
    ].join("\n");
